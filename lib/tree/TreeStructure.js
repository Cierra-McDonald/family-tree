...
class FamilyTree { 
  ...
  createFamilyTree() { 
    ...
    return keys;
    // stringify(everyone, (err, output) => {
    //   fs.writeFile('./TreeData.csv', output, 'utf8', (err) => { 
    //     if(err) { 
    //       console.log(err);
    //       return;
    //     } else { 
...
//   fs.writeFile('/lib/tree/TreeData.csv', output, 'utf8', (err) => { 
//     if(err) { 
//       console.log(err);
//       return;
//     } else { 
...
// fs.writeFile('/lib/tree/TreeData.txt', output,  => { 
//     if(err) { 
//       console.log(err);
//       return;
//     } else { 
